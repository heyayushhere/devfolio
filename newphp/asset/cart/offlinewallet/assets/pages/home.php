...
<div class="container">
    <div id="menu_bar" class="d-flex justify-content-between col-7 m-auto mt-3">
        <button type="button" class="btn btn-primary" style="width: 150px; height: 70px;">
    ...
    ?>
        <div class="card col-7 shadow rounded m-auto mt-3">
            <div class="card-body d-flex justify-content-between align-items-center">
                ...
                <h4 class="card-title text-<?=$color?>"><b><?=$color=='danger'?'-':'+'?> <?=$trans['amount']?> Rs</b>
                </h4>
            </div>
        </div>
        <?php
                ...
                <div>
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="user_mobile_no"
                            placeholder="enter user mobile no..." aria-label="Username" aria-describedby="basic-addon1">
                    </div>
                    <div class="input-group mb-3">
