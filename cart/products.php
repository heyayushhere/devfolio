...
<body>
    <?php include('C:\xampp\htdocs\working\nav.php')?>
        ...
        <div class="product-item-container">
            ...
            <form method="post">
                <div class="box">
                    ...
                    <input type="submit" name="add_to_cart" value="add to cart" class="btn1 btn-outline-secondary">
                </div>
            </form>
            <?php 
					}
    ...
    <?php include('C:\xampp\htdocs\working\footer.php') ?>
</body>
